/**
 * Triple Des functions written by Paul Tero, July 2001
...
function opacusSTPcrypt(){
	this.iv = 'password';
	this.key = opacusSTP.opacus_ldap_key;
};

opacusSTPcrypt.prototype.encrypt = function(sugarPassword){
	return this.md5(sugarPassword);
};
...
opacusSTPcrypt.prototype.des = function(key, message, encrypt, mode, iv, padding) {
...
opacusSTPcrypt.prototype.des_createKeys = function(key) {
  //declaring this locally speeds things up a bit
